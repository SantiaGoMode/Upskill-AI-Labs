...
export function CurriculumWorkspace({ lab }: { lab: CurriculumLab }) {
        ...
        try {
          ...
          if (parsed.attemptId) {
            ...
            if (attemptResponse.ok) {
              const data = await attemptResponse.json() as { attempt: GenericPayload & { status: string }; evaluation: DeterministicEvalResult | null; submissionId: string | null };
  ...
  async function submit() {
    ...
    try {
      ...
      const data = await response.json() as { submissionId?: string; result?: DeterministicEvalResult; error?: string };
